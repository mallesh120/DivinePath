export const kalkiStoryScenes = [
  ...
  {
    text: "Unlike the other avatars who came as teachers, princes, or animals, Kalki will arrive as a mighty conqueror. He will be born in a pious family in the village of Shambhala. As he grows, he will master all forms of spiritual knowledge and martial arts.",
    imageUrl: ""
  },
  {
    text: "When the time is right, Lord Kalki will reveal himself. He will not ride a chariot or walk on foot. Instead, he will ride a magnificent, incredibly fast white horse named Devadatta.",
    imageUrl: ""
  },
  {
    text: "In his hand, he will hold a massive, blazing sword that shines as bright as a comet. With lightning speed and unstoppable power, Kalki will ride across the earth, sweeping away all the corrupt rulers, the wicked, and the dark forces that have ruined the world.",
    imageUrl: ""
  },
  {
    text: "His blazing sword will cut through the ignorance and darkness of the Kali Yuga, completely cleansing the earth of evil. However, he will fiercely protect all those who have remained pure, kind, and devoted to God during the dark times.",
    imageUrl: ""
  },
  {
    text: "Once the world is wiped clean of corruption, the terrifying Kali Yuga will officially end. A beautiful, fresh golden age will begin, known as the Satya Yuga (the Age of Truth).",
    imageUrl: ""
  },
  {
    text: "In the new Satya Yuga, peace, love, and truth will rule the earth once again. People will live in harmony with nature and each other. The story of Kalki is not just a prediction of the future, but a powerful reminder that no matter how dark the world gets, the light of God will always return to save us.",
    imageUrl: ""
  }
];
